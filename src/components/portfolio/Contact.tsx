...
import { ArrowUpRight, Github, Linkedin, Mail, Globe, Phone } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <Reveal className="lg:col-span-7" delay={80}>
            <div className="space-y-6">
              <h3 className="font-heading text-[clamp(1.8rem,4vw,2.6rem)] text-[var(--heading)] leading-tight">
                Open to{" "}
                ...
                {LINKS.map((l) => (
                  <li key={l.label}>
                    <a
                      ...
                      className="group flex items-center gap-4 p-3 -mx-3 rounded-md hover:bg-[var(--bg)] transition-colors"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-[13px] text-[var(--heading)] truncate font-mono">
                          {l.handle}
                        </div>
                      </div>
                      <ArrowUpRight className="w-4 h-4 text-[var(--icon-muted)] group-hover:text-[var(--accent)] transition-colors" />
                    </a>
                  </li>
                ))}
              </ul>
